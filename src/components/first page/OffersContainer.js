...
export function OffersContainer() {
    return <div className="h-2/4 flex flex-nowrap gap-x-7 justify-center items-center">
        <BestOffersCard> 
            <p className='first_page_cards'><strong>Madrid</strong></p>
            <div className="container_first_card">
                <div className="price_card_container">
                    <p className='discount_card'>-27%</p>
                    <p className='price_card'> <span>€</span>48.<span>80</span> </p>
        ...
        <BestOffersCard>
        <p className='first_page_cards'><strong>Paris</strong></p>
            <div className="container_first_card">
                <div className="price_card_container">
                    <p className='discount_card'>-15%</p>
                    <p className='price_card'> <span>€</span>87.<span>80</span> </p>
        ...
        <p className='first_page_cards'><strong>Cagliari</strong></p>
            <div className="container_first_card">
                <div className="price_card_container">
                    <p className='discount_card'>-31%</p>
                    <p className='price_card'> <span>€</span>38.<span>50</span> </p>
