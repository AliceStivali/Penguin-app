      ...
      <div className="flex justify-center items-center">
        <div>
          ...
          <div className="flex gap-x-7 justify-center items-center">
            {weather === "Clear" && (
              <img width="200px" src="./meteo/sun/6.png" alt="" />
            )}
            {weather === "Rain" && (
              <img width="250px" src="./meteo/cloud/7.png" alt="" />
            )}
            {weather === "Fog" && (
              <img width="250px" src="./meteo/cloud/5.png" alt="" />
            )}
            {weather === "Thunderstorm" && (
              <img width="150px" src="./meteo/sun/16.png" alt="" />
            )}
            {weather === "Clouds" && (
              <img width="200px" src="./meteo/cloud/32.png" alt="" />
            )}
            {weather === "Mist" && (
              <img width="250px" src="./meteo/cloud/35.png" alt="" />
            )}
            {weather === "Snow" && (
              <img width="250px" src="./meteo/cloud/18.png" alt="" />
            )}
          </div>
          <div className="flex gap-x-7 justify-end ">
            <p className="weather_temp">{`${temp}°`}</p>
            <div style={{ color: "white" }}>
              <p className="weather_max">
                <b>{`${tempMax}°`}</b>
              </p>
              <p className="weather_min">
                {" "}
                <b>{`${tempMin}°`}</b>
              </p>
            </div>
